# coding: utf-8
# source: https://github.com/tctianchi/pyvenn/
# with some adjustments in font-sizes: bigger
# removed the additional text labels for each group. Legend is enough.
...
def draw_text(fig, ax, x, y, text, size=20, color=[0, 0, 0, 1]):
    ax.text(
        x, y, text,
...
def venn2(labels, names=['A', 'B'], **options):
    ...
    ymax = options.get('ymax',0.7)
    textsize = options.get('textsize',20)
    ...
    draw_text(fig, ax, 0.74, 0.30, labels.get('01', ''), textsize)
    draw_text(fig, ax, 0.26, 0.30, labels.get('10', ''), textsize)
    draw_text(fig, ax, 0.50, 0.30, labels.get('11', ''), textsize)
...
def venn3(labels, names=['A', 'B', 'C'], **options):
    ...
    draw_text(fig, ax, 0.50, 0.27, labels.get('001', ''), textsize)
    draw_text(fig, ax, 0.73, 0.65, labels.get('010', ''), textsize)
    draw_text(fig, ax, 0.61, 0.46, labels.get('011', ''), textsize)
    draw_text(fig, ax, 0.27, 0.65, labels.get('100', ''), textsize)
    draw_text(fig, ax, 0.39, 0.46, labels.get('101', ''), textsize)
    draw_text(fig, ax, 0.50, 0.65, labels.get('110', ''), textsize)
    draw_text(fig, ax, 0.50, 0.51, labels.get('111', ''), textsize)
    ...
    if legend:
        leg = ax.legend(names, loc='upper center', fancybox=True) #prop={'size': 12}
        leg.get_frame().set_alpha(0.5)
...
def venn4(labels, names=['A', 'B', 'C', 'D'], **options):
    ...
    draw_text(fig, ax, 0.85, 0.42, labels.get('0001', ''), textsize)
    draw_text(fig, ax, 0.68, 0.72, labels.get('0010', ''), textsize)
    draw_text(fig, ax, 0.77, 0.59, labels.get('0011', ''), textsize)
    draw_text(fig, ax, 0.32, 0.72, labels.get('0100', ''), textsize)
    draw_text(fig, ax, 0.71, 0.30, labels.get('0101', ''), textsize)
    draw_text(fig, ax, 0.50, 0.66, labels.get('0110', ''), textsize)
    draw_text(fig, ax, 0.65, 0.50, labels.get('0111', ''), textsize)
    draw_text(fig, ax, 0.14, 0.42, labels.get('1000', ''), textsize)
    draw_text(fig, ax, 0.50, 0.17, labels.get('1001', ''), textsize)
    draw_text(fig, ax, 0.29, 0.30, labels.get('1010', ''), textsize)
    draw_text(fig, ax, 0.39, 0.24, labels.get('1011', ''), textsize)
    draw_text(fig, ax, 0.23, 0.59, labels.get('1100', ''), textsize)
    draw_text(fig, ax, 0.61, 0.24, labels.get('1101', ''), textsize)
    draw_text(fig, ax, 0.35, 0.50, labels.get('1110', ''), textsize)
    draw_text(fig, ax, 0.50, 0.38, labels.get('1111', ''), textsize)
    ...
    if legend:
        leg = ax.legend(names, loc='upper center', fancybox=True)
        leg.get_frame().set_alpha(0.5)
...
def venn5(labels, names=['A', 'B', 'C', 'D', 'E'], **options):
    ...
    draw_text(fig, ax, 0.27, 0.11, labels.get('00001', ''), textsize)
    draw_text(fig, ax, 0.72, 0.11, labels.get('00010', ''), textsize)
    draw_text(fig, ax, 0.55, 0.13, labels.get('00011', ''), textsize)
    draw_text(fig, ax, 0.91, 0.58, labels.get('00100', ''), textsize)
    draw_text(fig, ax, 0.78, 0.64, labels.get('00101', ''), textsize)
    draw_text(fig, ax, 0.84, 0.41, labels.get('00110', ''), textsize)
    draw_text(fig, ax, 0.76, 0.55, labels.get('00111', ''), textsize)
    draw_text(fig, ax, 0.51, 0.90, labels.get('01000', ''), textsize)
    draw_text(fig, ax, 0.39, 0.15, labels.get('01001', ''), textsize)
    draw_text(fig, ax, 0.42, 0.78, labels.get('01010', ''), textsize)
    draw_text(fig, ax, 0.50, 0.15, labels.get('01011', ''), textsize)
    draw_text(fig, ax, 0.67, 0.76, labels.get('01100', ''), textsize)
    draw_text(fig, ax, 0.70, 0.71, labels.get('01101', ''), textsize)
    draw_text(fig, ax, 0.51, 0.74, labels.get('01110', ''), textsize)
    draw_text(fig, ax, 0.64, 0.67, labels.get('01111', ''), textsize)
    draw_text(fig, ax, 0.10, 0.61, labels.get('10000', ''), textsize)
    draw_text(fig, ax, 0.20, 0.31, labels.get('10001', ''), textsize)
    draw_text(fig, ax, 0.76, 0.25, labels.get('10010', ''), textsize)
    draw_text(fig, ax, 0.65, 0.23, labels.get('10011', ''), textsize)
    draw_text(fig, ax, 0.18, 0.50, labels.get('10100', ''), textsize)
    draw_text(fig, ax, 0.21, 0.37, labels.get('10101', ''), textsize)
    draw_text(fig, ax, 0.81, 0.37, labels.get('10110', ''), textsize)
    draw_text(fig, ax, 0.74, 0.40, labels.get('10111', ''), textsize)
    draw_text(fig, ax, 0.27, 0.70, labels.get('11000', ''), textsize)
    draw_text(fig, ax, 0.34, 0.25, labels.get('11001', ''), textsize)
    draw_text(fig, ax, 0.33, 0.72, labels.get('11010', ''), textsize)
    draw_text(fig, ax, 0.51, 0.22, labels.get('11011', ''), textsize)
    draw_text(fig, ax, 0.25, 0.58, labels.get('11100', ''), textsize)
    draw_text(fig, ax, 0.28, 0.39, labels.get('11101', ''), textsize)
    draw_text(fig, ax, 0.36, 0.66, labels.get('11110', ''), textsize)
    draw_text(fig, ax, 0.51, 0.47, labels.get('11111', ''), textsize)
    ...
    if legend:
        leg = ax.legend(names, loc='upper left', fancybox=True) # added prop here
        leg.get_frame().set_alpha(0.5)
